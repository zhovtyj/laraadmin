...
namespace zhovtyj\Laraadmin\Helpers;
...
/**
 * Class LAHelper
 * @package zhovtyj\Laraadmin\Helpers
 *
...
class LAHelper
{
    ...
    public static function print_menu_editor($menu)
    {
        ...
        $childrens = \zhovtyj\Laraadmin\Models\Menu::where("parent", $menu->id)->orderBy('hierarchy', 'asc')->get();
